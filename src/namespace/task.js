 ...
 * 获取当前任务的参数列表
 */
const GET_CURRENT_TASK_PARAMETER_DEF = 'TASK_GET_CURRENT_TASK_PARAMETER_DEF'
/**
 * 获取当前编辑中的任务插件使用情况
 */
const GET_CURRENT_TASK_PLUGIN_USAGE = 'TASK_GET_CURRENT_TASK_PLUGIN_USAGE'
 ...
 * 创建参数定义
 */
const ACT_CREATE_PARAMETER_DEF = 'TASK_ACT_CREATE_PARAMETER_DEF'
/**
 * 删除参数定义
 */
const ACT_DELETE_PARAMETER_DEF = 'TASK_ACT_DELETE_PARAMETER_DEF'
/**
 * 更新参数定义
 */
const ACT_UPDATE_PARAMETER_DEF = 'TASK_ACT_UPDATE_PARAMETER_DEF'
/**
 * 列出目前已有的参数定义
 */
const ACT_REFRESH_PARAMETER_DEF = 'TASK_ACT_REFRESH_PARAMETER_DEF'
/**
 * 更新当前任务中的插件使用情况
 */
const ACT_UPDATE_CURRENT_TASK_PLUGIN_USAGE = 'TASK_ACT_UPDATE_CURRENT_TASK_PLUGIN_USAGE'
/**
 * 刷新当前任务插件使用情况
 */
const ACT_REFRESH_CURRENT_TASK_PLUGIN_USAGE = 'TASK_ACT_REFRESH_CURRENT_TASK_PLUGIN_USAGE'
...
export default {
  ...
  GET_CURRENT_TASK_PARAMETER_DEF,
  GET_CURRENT_TASK_PLUGIN_USAGE,
  MUT_SET_STATE_EMPTY,
  ...
  ACT_CREATE_PARAMETER_DEF,
  ACT_DELETE_PARAMETER_DEF,
  ACT_UPDATE_PARAMETER_DEF,
  ACT_REFRESH_PARAMETER_DEF,
  ACT_UPDATE_CURRENT_TASK_PLUGIN_USAGE,
  ACT_REFRESH_CURRENT_TASK_PLUGIN_USAGE
}