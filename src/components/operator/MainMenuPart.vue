<template>
  <div class="main-menu-part">
    <div class="main-menu-part-line" :key="line" v-for="line in menu">
...
<style scoped>
  ...
  .main-menu-part-line:last-of-type {
    border-bottom: none;
  }

  .main-menu-part-item:nth-child(odd) {
